...
public class ServerTCP  extends Thread{
    ...
    public void run() {
        ...
        ServerSocket serverSocket = null;//potrzebny do komunikacji strumieniowej perr-to-peer klient-server.
        ...
        while(!this.isInterrupted()) {
            ...
            try {
                outputStream.flush(); //opróżnia strumien wyjsciowy i wymusza zapisanie danych z bufora.
                outputStream.close();
                imputStream.close();
